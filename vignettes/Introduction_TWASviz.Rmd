...
```{r}
sgl_fit1 <- TWASviz::sgl_TWAS(X = sgl_input1$X, y = sgl_input1$y, grouping = sgl_input1$groups, family = "binomial", offsets = sgl_input1$offsets, 
                              pred_loss = "misclass")

sgl_fit2 <- TWASviz::sgl_TWAS(X = sgl_input2$X, y = sgl_input2$y, grouping = sgl_input2$groups, family = "binomial", offsets = sgl_input2$offsets, 
                              pred_loss = "misclass")
```
